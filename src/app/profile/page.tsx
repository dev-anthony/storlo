              ...
              <div className="flex items-center gap-4">
                ...
                <div className="shrink-0">
                  <div className="block sm:hidden">
                    <Avatar avatar={profile.avatar} initials={initials} size={64} onUpload={handleAvatarUpload} />
                  </div>
                  <div className="hidden sm:block">
                    <Avatar avatar={profile.avatar} initials={initials} size={96} onUpload={handleAvatarUpload} />
                  </div>
                </div>
                ...
                {/* Edit button — icon-only on mobile, full label on sm+ */}
                <Button
                  onClick={() => setEditOpen(true)}
                  className="shrink-0 rounded-full bg-blue-500 text-white hover:bg-blue-600 shadow-md
                    h-9 w-9 p-0
                    sm:h-auto sm:w-auto sm:rounded-4xl sm:py-3 sm:px-5 sm:text-sm sm:font-semibold"
                >
